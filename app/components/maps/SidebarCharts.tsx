...
export const ReplayChart = ({ replaysData, metric }: ReplayChartProps): JSX.Element => {
    ...
    replaysData.forEach((replay: ReplayData) => {
        const replayData = replay.samples.map((sample) => [sample.currentRaceTime, readProp(sample, metric)]);
        replaySeries.push({
...
export const SidebarCharts = ({
    ...
    const toggleCheckbox = (e: any) => {
        ...
        } else if (selectedCharts.includes(e.target.name)) {
            ...
            >
                ...
                <div>
                    ...
                    {selectedCharts.map((metric) => (
                        <ReplayChart replaysData={replaysData} metric={metric} key={metric} />
                    ))}
                </div>
            </Drawer>
        </div>
